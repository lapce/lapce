...
const LANGUAGES: &[SyntaxProperties] = &[
    ...
    SyntaxProperties {
        ...
        injection: Some(include_str!("../queries/typescript/injections.scm")),
        comment: "//",
        indent: "    ",
        code_lens: (&["source_file", "program"], &["source_file"]),
    ...
    SyntaxProperties {
        ...
        injection: Some(include_str!("../queries/c/injections.scm")),
        comment: "//",
        indent: "    ",
        code_lens: (DEFAULT_CODE_LENS_LIST, DEFAULT_CODE_LENS_IGNORE_LIST),
        extensions: &["c", "h"],
    ...
    SyntaxProperties {
        ...
        injection: Some(include_str!("../queries/css/injections.scm")),
        comment: "/*",
        indent: "  ",
        code_lens: (DEFAULT_CODE_LENS_LIST, DEFAULT_CODE_LENS_IGNORE_LIST),
        extensions: &["css"],
    ...
    SyntaxProperties {
        ...
        injection: Some(include_str!("../queries/zig/injections.scm")),
        comment: "//",
        indent: "    ",
        code_lens: (DEFAULT_CODE_LENS_LIST, DEFAULT_CODE_LENS_IGNORE_LIST),
        extensions: &["zig"],
    ...
    SyntaxProperties {
        ...
        injection: Some(include_str!("../queries/bash/injections.scm")),
        comment: "#",
        indent: "  ",
        code_lens: (DEFAULT_CODE_LENS_LIST, DEFAULT_CODE_LENS_IGNORE_LIST),
        extensions: &["sh", "bash"],
