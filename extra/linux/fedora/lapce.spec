Name:           lapce-git
Version:        %VERSION%.{{{ git_dir_version }}}
Release:        1
...
BuildRequires:  cargo perl-FindBin cairo-devel cairo-gobject-devel atk-devel gdk-pixbuf2-devel pango-devel gtk3-devel perl-lib perl-File-Compare lld clang
...
%build
RUSTFLAGS="-C linker=clang -C link-arg=-fuse-ld=lld" cargo build --profile release-lto
