...
pub struct PluginHostHandler {
    ...
    pub server_init: InitializeResult,
...
impl PluginHostHandler {
    pub fn new(
        ...
        Self {
            ...
            catalog_rpc,
            server_rpc,
            server_init: InitializeResult::default(),
    ...
    pub fn method_registered(&self, method: &'static str) -> bool {
        match method {
            ...
            Completion::METHOD => {
                self.server_init.capabilities.completion_provider.is_some()
            }
            ...
            DidOpenTextDocument::METHOD => {
                match &self.server_init.capabilities.text_document_sync {
            ...
            SignatureHelpRequest::METHOD => self
                .server_init
                .capabilities
            ...
            GotoDefinition::METHOD => self
                ...
                .unwrap_or(false),
            GotoTypeDefinition::METHOD => self
                .server_init
                .capabilities
            ...
            InlayHintRequest::METHOD => {
                self.server_init.capabilities.inlay_hint_provider.is_some()
            }
            DocumentSymbolRequest::METHOD => self
                ...
                .is_some(),
            WorkspaceSymbol::METHOD => self
                .server_init
                .capabilities
                .workspace_symbol_provider
                .is_some(),
            PrepareRenameRequest::METHOD => {
                self.server_init.capabilities.rename_provider.is_some()
            }
            Rename::METHOD => {
                self.server_init.capabilities.rename_provider.is_some()
            }
            SelectionRangeRequest::METHOD => self
                .server_init
                .capabilities
                .selection_range_provider
                .is_some(),
            CodeActionResolveRequest::METHOD => {
                self.server_init.capabilities.code_action_provider.is_some()
            }
            _ => false,
        }
    }
    ...
    pub fn handle_did_change_text_document(
        ...
        let kind = match &self.server_init.capabilities.text_document_sync {
