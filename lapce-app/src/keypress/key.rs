            ...
            Self::Keyboard(key) => match key {
                ...
                Key::Named(n) => {
                    match n {
                        ...
                        floem::keyboard::NamedKey::ScrollLock => f.write_str("ScrollLock"),
                        floem::keyboard::NamedKey::Shift => f.write_str("Shift"),
                        floem::keyboard::NamedKey::Symbol => f.write_str("Symbol"),
                        floem::keyboard::NamedKey::SymbolLock => f.write_str("SymbolLock"),
                        ...
                        floem::keyboard::NamedKey::ArrowRight => f.write_str("ArrowRight"),
                        ...
                        floem::keyboard::NamedKey::ContextMenu => f.write_str("ContextMenu"),
                        ...
                        floem::keyboard::NamedKey::BrightnessDown => f.write_str("BrightnessDown"),
                        floem::keyboard::NamedKey::BrightnessUp => f.write_str("BrightnessUp"),
                        ...
                        floem::keyboard::NamedKey::PrintScreen => f.write_str("PrintScreen"),
                        ...
                        floem::keyboard::NamedKey::AllCandidates => f.write_str("AllCandidates"),
                        floem::keyboard::NamedKey::Alphanumeric => f.write_str("Alphanumeric"),
                        ...
                        floem::keyboard::NamedKey::GroupFirst => f.write_str("GroupFirst"),
                        floem::keyboard::NamedKey::GroupLast => f.write_str("GroupLast"),
                        floem::keyboard::NamedKey::GroupNext => f.write_str("GroupNext"),
                        floem::keyboard::NamedKey::GroupPrevious => f.write_str("GroupPrevious"),
                        floem::keyboard::NamedKey::ModeChange => f.write_str("ModeChange"),
                        floem::keyboard::NamedKey::NextCandidate => f.write_str("NextCandidate"),
                        floem::keyboard::NamedKey::NonConvert => f.write_str("NonConvert"),
                        floem::keyboard::NamedKey::PreviousCandidate => f.write_str("PreviousCandidate"),
                        floem::keyboard::NamedKey::Process => f.write_str("Process"),
                        floem::keyboard::NamedKey::SingleCandidate => f.write_str("SingleCandidate"),
                        floem::keyboard::NamedKey::HangulMode => f.write_str("HangulMode"),
                        ...
                        floem::keyboard::NamedKey::HiraganaKatakana => f.write_str("HiraganaKatakana"),
                        ...
                        floem::keyboard::NamedKey::ZenkakuHankaku => f.write_str("ZenkakuHankaku"),
                        ...
                        floem::keyboard::NamedKey::ChannelDown => f.write_str("ChannelDown"),
                        floem::keyboard::NamedKey::ChannelUp => f.write_str("ChannelUp"),
                        floem::keyboard::NamedKey::Close => f.write_str("Close"),
                        floem::keyboard::NamedKey::MailForward => f.write_str("MailForward"),
                        floem::keyboard::NamedKey::MailReply => f.write_str("MailReply"),
                        floem::keyboard::NamedKey::MailSend => f.write_str("MailSend"),
                        floem::keyboard::NamedKey::MediaClose => f.write_str("MediaClose"),
                        floem::keyboard::NamedKey::MediaFastForward => f.write_str("MediaFastForward"),
                        floem::keyboard::NamedKey::MediaPause => f.write_str("MediaPause"),
                        floem::keyboard::NamedKey::MediaPlay => f.write_str("MediaPlay"),
                        floem::keyboard::NamedKey::MediaPlayPause => f.write_str("MediaPlayPause"),
                        floem::keyboard::NamedKey::MediaRecord => f.write_str("MediaRecord"),
                        floem::keyboard::NamedKey::MediaRewind => f.write_str("MediaRewind"),
                        floem::keyboard::NamedKey::MediaStop => f.write_str("MediaStop"),
                        floem::keyboard::NamedKey::MediaTrackNext => f.write_str("MediaTrackNext"),
                        floem::keyboard::NamedKey::MediaTrackPrevious => f.write_str("MediaTrackPrevious"),
                        ...
                        floem::keyboard::NamedKey::SpellCheck => f.write_str("SpellCheck"),
                        floem::keyboard::NamedKey::Key11 => f.write_str("Key11"),
                        floem::keyboard::NamedKey::Key12 => f.write_str("Key12"),
                        floem::keyboard::NamedKey::AudioBalanceLeft => f.write_str("AudioBalanceLeft"),
                        floem::keyboard::NamedKey::AudioBalanceRight => f.write_str("AudioBalanceRight"),
                        floem::keyboard::NamedKey::AudioBassBoostDown => f.write_str("AudioBassBoostDown"),
                        floem::keyboard::NamedKey::AudioBassBoostToggle => f.write_str("AudioBassBoostToggle"),
                        floem::keyboard::NamedKey::AudioBassBoostUp => f.write_str("AudioBassBoostUp"),
                        floem::keyboard::NamedKey::AudioFaderFront => f.write_str("AudioFaderFront"),
                        floem::keyboard::NamedKey::AudioFaderRear => f.write_str("AudioFaderRear"),
                        floem::keyboard::NamedKey::AudioSurroundModeNext => f.write_str("AudioSurroundModeNext"),
                        floem::keyboard::NamedKey::AudioTrebleDown => f.write_str("AudioTrebleDown"),
                        floem::keyboard::NamedKey::AudioTrebleUp => f.write_str("AudioTrebleUp"),
                        floem::keyboard::NamedKey::AudioVolumeDown => f.write_str("AudioVolumeDown"),
                        floem::keyboard::NamedKey::AudioVolumeUp => f.write_str("AudioVolumeUp"),
                        floem::keyboard::NamedKey::AudioVolumeMute => f.write_str("AudioVolumeMute"),
                        floem::keyboard::NamedKey::MicrophoneToggle => f.write_str("MicrophoneToggle"),
                        floem::keyboard::NamedKey::MicrophoneVolumeDown => f.write_str("MicrophoneVolumeDown"),
                        floem::keyboard::NamedKey::MicrophoneVolumeUp => f.write_str("MicrophoneVolumeUp"),
                        floem::keyboard::NamedKey::MicrophoneVolumeMute => f.write_str("MicrophoneVolumeMute"),
                        floem::keyboard::NamedKey::SpeechCorrectionList => f.write_str("SpeechCorrectionList"),
                        floem::keyboard::NamedKey::SpeechInputToggle => f.write_str("SpeechInputToggle"),
                        floem::keyboard::NamedKey::LaunchApplication1 => f.write_str("LaunchApplication1"),
                        floem::keyboard::NamedKey::LaunchApplication2 => f.write_str("LaunchApplication2"),
                        floem::keyboard::NamedKey::LaunchCalendar => f.write_str("LaunchCalendar"),
                        floem::keyboard::NamedKey::LaunchContacts => f.write_str("LaunchContacts"),
                        floem::keyboard::NamedKey::LaunchMail => f.write_str("LaunchMail"),
                        floem::keyboard::NamedKey::LaunchMediaPlayer => f.write_str("LaunchMediaPlayer"),
                        floem::keyboard::NamedKey::LaunchMusicPlayer => f.write_str("LaunchMusicPlayer"),
                        floem::keyboard::NamedKey::LaunchPhone => f.write_str("LaunchPhone"),
                        floem::keyboard::NamedKey::LaunchScreenSaver => f.write_str("LaunchScreenSaver"),
                        floem::keyboard::NamedKey::LaunchSpreadsheet => f.write_str("LaunchSpreadsheet"),
                        floem::keyboard::NamedKey::LaunchWebBrowser => f.write_str("LaunchWebBrowser"),
                        floem::keyboard::NamedKey::LaunchWebCam => f.write_str("LaunchWebCam"),
                        floem::keyboard::NamedKey::LaunchWordProcessor => f.write_str("LaunchWordProcessor"),
                        floem::keyboard::NamedKey::BrowserBack => f.write_str("BrowserBack"),
                        floem::keyboard::NamedKey::BrowserFavorites => f.write_str("BrowserFavorites"),
                        floem::keyboard::NamedKey::BrowserForward => f.write_str("BrowserForward"),
                        floem::keyboard::NamedKey::BrowserHome => f.write_str("BrowserHome"),
                        floem::keyboard::NamedKey::BrowserRefresh => f.write_str("BrowserRefresh"),
                        floem::keyboard::NamedKey::BrowserSearch => f.write_str("BrowserSearch"),
                        floem::keyboard::NamedKey::BrowserStop => f.write_str("BrowserStop"),
                        ...
                        floem::keyboard::NamedKey::CameraFocus => f.write_str("CameraFocus"),
                        ...
                        floem::keyboard::NamedKey::HeadsetHook => f.write_str("HeadsetHook"),
                        floem::keyboard::NamedKey::LastNumberRedial => f.write_str("LastNumberRedial"),
                        floem::keyboard::NamedKey::Notification => f.write_str("Notification"),
                        floem::keyboard::NamedKey::MannerMode => f.write_str("MannerMode"),
                        ...
                        floem::keyboard::NamedKey::TVAntennaCable => f.write_str("TVAntennaCable"),
                        floem::keyboard::NamedKey::TVAudioDescription => f.write_str("TVAudioDescription"),
                        floem::keyboard::NamedKey::TVAudioDescriptionMixDown => f.write_str("TVAudioDescriptionMixDown"),
                        floem::keyboard::NamedKey::TVAudioDescriptionMixUp => f.write_str("TVAudioDescriptionMixUp"),
                        floem::keyboard::NamedKey::TVContentsMenu => f.write_str("TVContentsMenu"),
                        floem::keyboard::NamedKey::TVDataService => f.write_str("TVDataService"),
                        floem::keyboard::NamedKey::TVInput => f.write_str("TVInput"),
                        floem::keyboard::NamedKey::TVInputComponent1 => f.write_str("TVInputComponent1"),
                        floem::keyboard::NamedKey::TVInputComponent2 => f.write_str("TVInputComponent2"),
                        floem::keyboard::NamedKey::TVInputComposite1 => f.write_str("TVInputComposite1"),
                        floem::keyboard::NamedKey::TVInputComposite2 => f.write_str("TVInputComposite2"),
                        floem::keyboard::NamedKey::TVInputHDMI1 => f.write_str("TVInputHDMI1"),
                        floem::keyboard::NamedKey::TVInputHDMI2 => f.write_str("TVInputHDMI2"),
                        floem::keyboard::NamedKey::TVInputHDMI3 => f.write_str("TVInputHDMI3"),
                        floem::keyboard::NamedKey::TVInputHDMI4 => f.write_str("TVInputHDMI4"),
                        floem::keyboard::NamedKey::TVInputVGA1 => f.write_str("TVInputVGA1"),
                        floem::keyboard::NamedKey::TVMediaContext => f.write_str("TVMediaContext"),
                        floem::keyboard::NamedKey::TVNetwork => f.write_str("TVNetwork"),
                        floem::keyboard::NamedKey::TVNumberEntry => f.write_str("TVNumberEntry"),
                        floem::keyboard::NamedKey::TVPower => f.write_str("TVPower"),
                        floem::keyboard::NamedKey::TVRadioService => f.write_str("TVRadioService"),
                        floem::keyboard::NamedKey::TVSatellite => f.write_str("TVSatellite"),
                        floem::keyboard::NamedKey::TVSatelliteBS => f.write_str("TVSatelliteBS"),
                        floem::keyboard::NamedKey::TVSatelliteCS => f.write_str("TVSatelliteCS"),
                        floem::keyboard::NamedKey::TVSatelliteToggle => f.write_str("TVSatelliteToggle"),
                        floem::keyboard::NamedKey::TVTerrestrialAnalog => f.write_str("TVTerrestrialAnalog"),
                        floem::keyboard::NamedKey::TVTerrestrialDigital => f.write_str("TVTerrestrialDigital"),
                        ...
                        floem::keyboard::NamedKey::ColorF0Red => f.write_str("ColorF0Red"),
                        floem::keyboard::NamedKey::ColorF1Green => f.write_str("ColorF1Green"),
                        floem::keyboard::NamedKey::ColorF2Yellow => f.write_str("ColorF2Yellow"),
                        floem::keyboard::NamedKey::ColorF3Blue => f.write_str("ColorF3Blue"),
                        floem::keyboard::NamedKey::ColorF4Grey => f.write_str("ColorF4Grey"),
                        floem::keyboard::NamedKey::ColorF5Brown => f.write_str("ColorF5Brown"),
                        floem::keyboard::NamedKey::ClosedCaptionToggle => f.write_str("ClosedCaptionToggle"),
                        floem::keyboard::NamedKey::Dimmer => f.write_str("Dimmer"),
                        floem::keyboard::NamedKey::DisplaySwap => f.write_str("DisplaySwap"),
                        floem::keyboard::NamedKey::DVR => f.write_str("DVR"),
                        floem::keyboard::NamedKey::Exit => f.write_str("Exit"),
                        floem::keyboard::NamedKey::FavoriteClear0 => f.write_str("FavoriteClear0"),
                        floem::keyboard::NamedKey::FavoriteClear1 => f.write_str("FavoriteClear1"),
                        floem::keyboard::NamedKey::FavoriteClear2 => f.write_str("FavoriteClear2"),
                        floem::keyboard::NamedKey::FavoriteClear3 => f.write_str("FavoriteClear3"),
                        floem::keyboard::NamedKey::FavoriteRecall0 => f.write_str("FavoriteRecall0"),
                        floem::keyboard::NamedKey::FavoriteRecall1 => f.write_str("FavoriteRecall1"),
                        floem::keyboard::NamedKey::FavoriteRecall2 => f.write_str("FavoriteRecall2"),
                        floem::keyboard::NamedKey::FavoriteRecall3 => f.write_str("FavoriteRecall3"),
                        floem::keyboard::NamedKey::FavoriteStore0 => f.write_str("FavoriteStore0"),
                        floem::keyboard::NamedKey::FavoriteStore1 => f.write_str("FavoriteStore1"),
                        floem::keyboard::NamedKey::FavoriteStore2 => f.write_str("FavoriteStore2"),
                        floem::keyboard::NamedKey::FavoriteStore3 => f.write_str("FavoriteStore3"),
                        floem::keyboard::NamedKey::Guide => f.write_str("Guide"),
                        floem::keyboard::NamedKey::GuideNextDay => f.write_str("GuideNextDay"),
                        floem::keyboard::NamedKey::GuidePreviousDay => f.write_str("GuidePreviousDay"),
                        floem::keyboard::NamedKey::Info => f.write_str("Info"),
                        floem::keyboard::NamedKey::InstantReplay => f.write_str("InstantReplay"),
                        floem::keyboard::NamedKey::Link => f.write_str("Link"),
                        floem::keyboard::NamedKey::ListProgram => f.write_str("ListProgram"),
                        floem::keyboard::NamedKey::LiveContent => f.write_str("LiveContent"),
                        floem::keyboard::NamedKey::Lock => f.write_str("Lock"),
                        floem::keyboard::NamedKey::MediaApps => f.write_str("MediaApps"),
                        floem::keyboard::NamedKey::MediaAudioTrack => f.write_str("MediaAudioTrack"),
                        floem::keyboard::NamedKey::MediaLast => f.write_str("MediaLast"),
                        floem::keyboard::NamedKey::MediaSkipBackward => f.write_str("MediaSkipBackward"),
                        floem::keyboard::NamedKey::MediaSkipForward => f.write_str("MediaSkipForward"),
                        floem::keyboard::NamedKey::MediaStepBackward => f.write_str("MediaStepBackward"),
                        floem::keyboard::NamedKey::MediaStepForward => f.write_str("MediaStepForward"),
                        floem::keyboard::NamedKey::MediaTopMenu => f.write_str("MediaTopMenu"),
                        floem::keyboard::NamedKey::NavigateIn => f.write_str("NavigateIn"),
                        floem::keyboard::NamedKey::NavigateNext => f.write_str("NavigateNext"),
                        floem::keyboard::NamedKey::NavigateOut => f.write_str("NavigateOut"),
                        floem::keyboard::NamedKey::NavigatePrevious => f.write_str("NavigatePrevious"),
                        floem::keyboard::NamedKey::NextFavoriteChannel => f.write_str("NextFavoriteChannel"),
                        floem::keyboard::NamedKey::NextUserProfile => f.write_str("NextUserProfile"),
                        ...
                        floem::keyboard::NamedKey::PinPToggle => f.write_str("PinPToggle"),
                        floem::keyboard::NamedKey::PinPUp => f.write_str("PinPUp"),
                        floem::keyboard::NamedKey::PlaySpeedDown => f.write_str("PlaySpeedDown"),
                        floem::keyboard::NamedKey::PlaySpeedReset => f.write_str("PlaySpeedReset"),
                        floem::keyboard::NamedKey::PlaySpeedUp => f.write_str("PlaySpeedUp"),
                        floem::keyboard::NamedKey::RandomToggle => f.write_str("RandomToggle"),
                        floem::keyboard::NamedKey::RcLowBattery => f.write_str("RcLowBattery"),
                        floem::keyboard::NamedKey::RecordSpeedNext => f.write_str("RecordSpeedNext"),
                        floem::keyboard::NamedKey::RfBypass => f.write_str("RfBypass"),
                        floem::keyboard::NamedKey::ScanChannelsToggle => f.write_str("ScanChannelsToggle"),
                        floem::keyboard::NamedKey::ScreenModeNext => f.write_str("ScreenModeNext"),
                        floem::keyboard::NamedKey::Settings => f.write_str("Settings"),
                        floem::keyboard::NamedKey::SplitScreenToggle => f.write_str("SplitScreenToggle"),
                        ...
                        floem::keyboard::NamedKey::VideoModeNext => f.write_str("VideoModeNext"),
                        floem::keyboard::NamedKey::Wink => f.write_str("Wink"),
                        floem::keyboard::NamedKey::ZoomToggle => f.write_str("ZoomToggle"),
