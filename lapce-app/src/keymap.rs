                ...
                (
                    ...
                    }),
                    {
                        ...
                        list(
                            ...
                            |k| k.clone(),
                            move |key| {
                                label(move || key.clone()).style(move |base| {
                    ...
                    },
                    {
                        ...
                        list(
                            ...
                            |m| m.clone(),
                            move |mode| {
                                label(move || mode.clone()).style(move |base| {
                                    base.padding_horiz_px(5.0)
                                        .padding_vert_px(1.0)
                                        .margin_right_px(5.0)
                                        .border(1.0)
        ...
        (
            {
                ...
                .style(|base| base.padding_bottom_px(10.0).width_pct(100.0))
            },
            stack(move || {
                (
                    container(|| {
                        label(|| "Command".to_string()).style(move |base| {
                            base.text_ellipsis()
                                .padding_horiz_px(10.0)
                                .min_width_px(0.0)
                        })
                    ...
                    label(|| "Key Binding".to_string()).style(move |base| {
                        base.width_px(200.0)
                            .items_center()
                            .padding_horiz_px(10.0)
                            .height_pct(100.0)
                    ...
                    label(|| "Modes".to_string()).style(move |base| {
                        base.width_px(200.0)
                            .items_center()
                            .padding_horiz_px(10.0)
                            .height_pct(100.0)
                    ...
                    container(|| {
                        label(|| "When".to_string()).style(move |base| {
                            base.text_ellipsis()
                                .padding_horiz_px(10.0)
                                .min_width_px(0.0)
                        })
            ...
            .style(|base| base.width_pct(100.0).flex_basis_px(0.0).flex_grow(1.0)),
