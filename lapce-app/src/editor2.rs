...
use floem::{
    ...
    reactive::{batch, use_context, RwSignal, Scope},
};
use floem_editor::{
    command::CommandExecuted, editor::Editor, id::EditorId, movement,
    view::ScreenLines,
};
use lapce_core::{
...
impl KeyPressFocus for EditorData2 {
