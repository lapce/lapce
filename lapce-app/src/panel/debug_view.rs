        ...
        (
            {
                ...
                .style(|base| base.width_pct(100.0).flex_col().height_px(150.0))
            },
            stack(move || {
                (
            ...
            move |(term_id, p)| {
                ...
                stack(move || {
                    (
                        ...
                        label(move || p.config.name.clone()).style(|base| {
                            base.flex_grow(1.0)
                                .flex_basis_px(0.0)
                                .min_width_px(0.0)
                                .text_ellipsis()
    ...
    stack(move || {
        (
            container(|| label(move || thread_id.to_string()))
                ...
                .style(|base| base.padding_horiz_px(10.0).min_width_pct(100.0))
                .hover_style(move |base| {
                    base.cursor(CursorStyle::Pointer).background(
                        *config
                            .get()
            ...
            .style(|base| base.flex_col().min_width_pct(100.0)),
        )
    })
    .style(|base| base.flex_col().min_width_pct(100.0))
}
